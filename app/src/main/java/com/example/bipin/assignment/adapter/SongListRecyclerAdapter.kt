...
class SongListRecyclerAdapter(private val mContext: Context,
                              private val mDashBoardMenuItemBeans: ArrayList<DashBoardMenuItemBean>) : RecyclerView.Adapter<SongListRecyclerAdapter.ViewHolder>() {
